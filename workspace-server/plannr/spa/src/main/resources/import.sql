...
insert into TBL_USER(ACTIVATION_SALT,COUNTRY_CODE,EMAIL,FIRST_NAME,LAST_NAME,PASSWORD,SELF_REGISTERED,VALIDATED) VALUES(1234,'CHE','raffael.schmid@trivadis.com','Raffael','Schmid','plannr',1,1);
